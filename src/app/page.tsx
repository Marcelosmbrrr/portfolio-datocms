            ...
            <nav className="border-gray-200 px-4 lg:px-6 py-2.5">
              <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                <div className="flex items-center">
                  ...
                  <span className="hidden sm:block self-center text-red-500 text-2xl font-semibold whitespace-nowrap">
                    smbr
                  </span>
                  <span className="sm:hidden text-white self-center text-2xl font-semibold whitespace-nowrap">
                    smbr
                  </span>
                </div>
          ...
          <main className="mt-6">
            <section className="grid max-w-screen-xl mt-10 px-4 mx-auto lg:gap-8 xl:gap-0 py-20 lg:grid-cols-12">
              <div className="mr-auto place-self-center lg:col-span-7">
                <h1 className="max-w-4xl mb-4 text-6xl font-extrabold tracking-tight leading-none dark:text-red-600">
                  Marcelo<span className="text-gray-800">SMBR</span>
                </h1>
