            ...
            <header>
              <nav className="border-gray-200 dark:border-gray-700 px-4 lg:px-6 py-2.5">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                  <div className="flex items-center text-gray-800 dark:text-gray-200 md:text-red-600">
                    <svg
                      className="w-6 h-6"
                      aria-hidden="true"
                    ...
                    <ul className="flex items-center mt-4 font-medium space-x-3">
                      <li>
                        <a
                          ...
                          target="_blank"
                          className="block text-gray-900 dark:text-gray-200 cursor-pointer"
                        >
                          <svg
                            className="w-7 h-7"
                            aria-hidden="true"
                      ...
                      <li>
                        <a
                          ...
                          target="_blank"
                          className="flex text-gray-900 dark:text-gray-200 cursor-pointer"
                        >
                          <svg
                            className="w-7 h-7"
                            aria-hidden="true"
            ...
            <main className="mt-6">
              <section className="grid max-w-screen-xl mt-10 px-4 mx-auto lg:gap-8 xl:gap-0 py-20 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7">
                  <h1 className="max-w-4xl mb-4 text-6xl font-extrabold tracking-tight leading-none text-gray-900 dark:text-gray-100">
                    Marcelo<span className="text-red-600">SMBR</span>
                  </h1>
                  <p className="max-w-2xl mb-6 font-light lg:mb-8 md:text-lg lg:text-xl text-gray-700 dark:text-gray-300">
                    Desenvolvedor Fullstack
                  </p>
                  <a
                    href="mailto:marcelosm.dev@gmail.com"
                    target="_blank"
                    className="mr-2 inline-flex items-center justify-center px-5 py-3 text-base font-medium text-white bg-stone-800 rounded-lg shadow transition duration-300 ease-in-out transform hover:scale-105"
                  >
                    Entre em Contato
                  </a>
                  <a
                    ...
                    target="_blank"
                    className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-white bg-stone-800 rounded-lg shadow transition duration-300 ease-in-out transform hover:scale-105"
                  >
                    Currículo
                  </a>
                </div>
            ...
            <footer>
              <div className="w-full p-4 md:py-8">
                ...
                <span className="block text-sm text-gray-600 dark:text-gray-400 sm:text-center">
                  © 2024 <span className="text-red-600">Portfolio SMBR</span>.
                </span>
              </div>
            </footer>
          </div>
